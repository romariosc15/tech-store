<template>
  ...
  <div class="px-4 md:px-12 xl:px-28 2xl:px-48 mt-12 mb-24 space-y-6 text-gray-800 text-sm md:text-base">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 xl:gap-12 py-4 md:py-6">
      <img class="w-full h-[800px] object-cover rounded-lg" src="/src/assets/images/about-us/ceo.png" alt="CEO">
      <div>
        ...
        <div class="space-y-6">
          ...
          <p>
            Vestibulum in orci ac nisl condimentum fermentum at et sem. Curabitur fermentum dolor eu lacus consectetur varius. Pellentesque efficitur elit ante, vel vulputate tortor blandit nec. Integer tortor nulla, ultricies et nisi sit amet, interdum dictum felis.
          </p>
        </div>
      </div>
    </div>
